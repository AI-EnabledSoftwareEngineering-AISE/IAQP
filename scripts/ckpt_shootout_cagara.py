...
parser = argparse.ArgumentParser(description="CAGRA Checkpoint Shootout")
...
parser.add_argument("--exact_k", action="store_true", 
                   help="Load exact_k checkpoints instead of CAGRA checkpoints")
...
if args.exact_k:
    ...
    base_path = f"outputs/checkpoints/{args.dataset}-3m_cuvs_cagra_ann_only_up_to_e3"
else:
    base_path = f"outputs/checkpoints/{args.dataset}-3m_cuvs_cagra_up_to_e3"
...
if args.exact_k:
    ...
    checkpoint_type = "cuvs_cagra_ann_only"
else:
    checkpoint_type = "cuvs_cagra"
